namespace SolarOS_beta_
{
    internal class FontGui
    {
        ...
        public static uint[] n0 = new uint[8]; //n = numero
        ...
        public static uint[] quote = new uint[8];
    ...
    internal class FontGuiImpl : FontGui
    {
